...
uint8_t SnsACTest(uint8_t channel)
{
   ...
   for(uint32_t i=0;i<testNum;i++)
   {
      ...
      else
      {
        ...
        //AfeSwitchDPNT(SWID_D6_CE1,SWID_P12_CE1,SWID_N7_SE1RLOAD,SWID_T7_SE1RLOAD|SWID_T9); // Matchbox 1
        //AfeSwitchDPNT(SWID_D5_CE0,SWID_P11_CE0,SWID_N5_SE0RLOAD,SWID_T5_SE0RLOAD|SWID_T9); // Matchbox 2
        //AfeSwitchDPNT(SWID_D6_CE1,SWID_P12_CE1,SWID_N2_AIN1,SWID_T2_AIN1|SWID_T9); // Matchbox 3
        //AfeSwitchDPNT(SWID_D5_CE0,SWID_P11_CE0,SWID_N3_AIN2,SWID_T3_AIN2|SWID_T9); // Matchbox 4
