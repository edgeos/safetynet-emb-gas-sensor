...
#define pREG_TMR0_CURCNT                 ((__I __C  int16_t   *) REG_TMR0_CURCNT)                 /*  16-bit timer value */
...
#define pREG_TMR0_CAPTURE                ((__I __C  int16_t   *) REG_TMR0_CAPTURE)                /*  Capture */
#define pREG_TMR0_ALOAD                  ((__IO     int16_t   *) REG_TMR0_ALOAD)                  /*  16-bit load value, asynchronous */
#define pREG_TMR0_ACURCNT                ((__I __C  int16_t   *) REG_TMR0_ACURCNT)                /*  16-bit timer value, asynchronous */
...
#define pREG_TMR1_CURCNT                 ((__I __C  int16_t   *) REG_TMR1_CURCNT)                 /*  16-bit timer value */
...
#define pREG_TMR1_CAPTURE                ((__I __C  int16_t   *) REG_TMR1_CAPTURE)                /*  Capture */
#define pREG_TMR1_ALOAD                  ((__IO     int16_t   *) REG_TMR1_ALOAD)                  /*  16-bit load value, asynchronous */
#define pREG_TMR1_ACURCNT                ((__I __C  int16_t   *) REG_TMR1_ACURCNT)                /*  16-bit timer value, asynchronous */
...
#define pREG_TMR2_CURCNT                 ((__I __C  int16_t   *) REG_TMR2_CURCNT)                 /*  16-bit timer value */
...
#define pREG_TMR2_CAPTURE                ((__I __C  int16_t   *) REG_TMR2_CAPTURE)                /*  Capture */
#define pREG_TMR2_ALOAD                  ((__IO     int16_t   *) REG_TMR2_ALOAD)                  /*  16-bit load value, asynchronous */
#define pREG_TMR2_ACURCNT                ((__I __C  int16_t   *) REG_TMR2_ACURCNT)                /*  16-bit timer value, asynchronous */
...
#define pREG_WDT0_CCNT                   ((__I __C  int16_t   *) REG_WDT0_CCNT)                   /*  Current count value */
 ...
 *       (UART0)
 *  ================================================================================= */
#define pREG_UART0_COMRX                 ((__I __C  uint16_t  *) REG_UART0_COMRX)                 /*  Receive Buffer Register */
...
#define pREG_UART0_COMIIR                ((__I __C  uint16_t  *) REG_UART0_COMIIR)                /*  Interrupt ID */
...
#define pREG_UART0_COMLSR                ((__I __C  uint16_t  *) REG_UART0_COMLSR)                /*  Line Status */
#define pREG_UART0_COMMSR                ((__I __C  uint16_t  *) REG_UART0_COMMSR)                /*  Modem Status */
...
#define pREG_UART0_COMRFC                ((__I __C  uint16_t  *) REG_UART0_COMRFC)                /*  RX FIFO byte count */
#define pREG_UART0_COMTFC                ((__I __C  uint16_t  *) REG_UART0_COMTFC)                /*  TX FIFO byte count */
...
#define pREG_UART0_COMASRL               ((__I __C  uint16_t  *) REG_UART0_COMASRL)               /*  Auto Baud Status (Low) */
#define pREG_UART0_COMASRH               ((__I __C  uint16_t  *) REG_UART0_COMASRH)               /*  Auto Baud Status (High) */
...
#define pREG_DMA0_ADBPTR                 ((__I __C  int32_t   *) REG_DMA0_ADBPTR)                 /*  DMA channel alternate control data base pointer */
...
#define pREG_FLCC0_WR_ABORT_ADDR         ((__I __C  int32_t   *) REG_FLCC0_WR_ABORT_ADDR)         /*  Write Abort Address */
#define pREG_FLCC0_WRPROT                ((__IO     int32_t   *) REG_FLCC0_WRPROT)                /*  Write Protection */
#define pREG_FLCC0_SIGNATURE             ((__I __C  int32_t   *) REG_FLCC0_SIGNATURE)             /*  Signature */
...
#define pREG_CRYPT0_OUTBUF               ((__I __C  int32_t   *) REG_CRYPT0_OUTBUF)               /*  Output Buffer */
...
#define pREG_AGPIO2_IN                   ((__I __C  uint16_t  *) REG_AGPIO2_IN)                   /*  GPIO Port Registered Data Input */
 ...
 *       (AFECON)
 *  ================================================================================= */
#define pREG_AFECON_ADIID                ((__I __C  uint16_t  *) REG_AFECON_ADIID)                /*  ADI Identification */
#define pREG_AFECON_CHIPID               ((__I __C  uint16_t  *) REG_AFECON_CHIPID)               /*  Chip Identification */
...
#define pREG_AFEWDT_WDTVALS              ((__I __C  int16_t   *) REG_AFEWDT_WDTVALS)              /*  Current Count Value */
...
#define pREG_ALLON_PMUSTA                ((__I __C  uint16_t  *) REG_ALLON_PMUSTA)                /*  PMU Status */
...
#define pREG_AGPT0_VAL0                  ((__I __C  int16_t   *) REG_AGPT0_VAL0)                  /*  16-Bit Timer Value Register. */
...
#define pREG_AGPT0_CAP0                  ((__I __C  int16_t   *) REG_AGPT0_CAP0)                  /*  Capture Register. */
#define pREG_AGPT0_ALD0                  ((__IO     int16_t   *) REG_AGPT0_ALD0)                  /*  16-Bit Load Value, Asynchronous. */
#define pREG_AGPT0_AVAL0                 ((__I __C  int16_t   *) REG_AGPT0_AVAL0)                 /*  16-Bit Timer Value, Asynchronous Register. */
#define pREG_AGPT0_STA0                  ((__I __C  uint16_t  *) REG_AGPT0_STA0)                  /*  Status Register. */
...
#define pREG_AGPT1_VAL1                  ((__I __C  int16_t   *) REG_AGPT1_VAL1)                  /*  16-bit Timer Value Register */
...
#define pREG_AGPT1_CAP1                  ((__I __C  int16_t   *) REG_AGPT1_CAP1)                  /*  Capture Register */
#define pREG_AGPT1_ALD1                  ((__IO     int16_t   *) REG_AGPT1_ALD1)                  /*  16-bit Load Value, Asynchronous Register */
#define pREG_AGPT1_AVAL1                 ((__I __C  int16_t   *) REG_AGPT1_AVAL1)                 /*  16-bit Timer Value, Asynchronous Register */
#define pREG_AGPT1_STA1                  ((__I __C  uint16_t  *) REG_AGPT1_STA1)                  /*  Status Register */
...
#define pREG_AFE_DSWSTA                  ((__I __C  uint32_t  *) REG_AFE_DSWSTA)                  /*  Switch Matrix Status (D) */
#define pREG_AFE_PSWSTA                  ((__I __C  uint32_t  *) REG_AFE_PSWSTA)                  /*  Switch Matrix Status (P) */
#define pREG_AFE_NSWSTA                  ((__I __C  uint32_t  *) REG_AFE_NSWSTA)                  /*  Switch Matrix Status (N) */
#define pREG_AFE_TSWSTA                  ((__I __C  uint32_t  *) REG_AFE_TSWSTA)                  /*  Switch Matrix Status (T) */
#define pREG_AFE_STATSVAR                ((__I __C  uint32_t  *) REG_AFE_STATSVAR)                /*  Variance Output */
#define pREG_AFE_STATSCON                ((__IO     uint32_t  *) REG_AFE_STATSCON)                /*  Statistics Control */
#define pREG_AFE_STATSMEAN               ((__I __C  uint32_t  *) REG_AFE_STATSMEAN)               /*  Statistics Mean Output */
