...
#define BITM_SPI_STAT_CSRISE                 (_ADI_MSK_3(0x00004000,0x00004000U, uint16_t  ))    /*  Detected a rising edge on CS, in slave CON mode */
#define BITM_SPI_STAT_CSFALL                 (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  Detected a falling edge on CS, in slave CON mode */
