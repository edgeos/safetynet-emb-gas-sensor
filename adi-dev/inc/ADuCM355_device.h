...
typedef struct _ADI_TMR_TypeDef
{
    ...
    __I __C  int16_t    CURCNT;                        /*!< 16-bit timer value */
...
typedef struct _ADI_WDT_TypeDef
{
    ...
    __I __C  uint8_t  RESERVED0[2];
    __I __C  int16_t    CCNT;                          /*!< Current count value */
    __I __C  uint8_t  RESERVED1[2];
    __IO     uint16_t   CTL;                           /*!< Control */
    __I __C  uint8_t  RESERVED2[2];
...
typedef struct _ADI_DMA_TypeDef
{
    ...
    __I __C  int32_t    ADBPTR;                        /*!< DMA channel alternate control data base pointer */
...
typedef struct _ADI_FLCC_TypeDef
{
    ...
    __O      int32_t    KEY;                           /*!< Key */
    __I __C  int32_t    WR_ABORT_ADDR;                 /*!< Write Abort Address */
    __IO     int32_t    WRPROT;                        /*!< Write Protection */
    __I __C  int32_t    SIGNATURE;                     /*!< Signature */
...
typedef struct _ADI_CRYPT_TypeDef
{
    ...
    __I __C  int32_t    OUTBUF;                        /*!< Output Buffer */
...
typedef struct _ADI_AGPIO_TypeDef
{
    ...
    __I __C  uint8_t  RESERVED2[2];
    __I __C  uint16_t   IN;                            /*!< GPIO Port Registered Data Input */
    __I __C  uint8_t  RESERVED3[2];
...
typedef struct _ADI_AFEWDT_TypeDef
{
    ...
    __I __C  uint8_t  RESERVED0[2];
    __I __C  int16_t    WDTVALS;                       /*!< Current Count Value */
    __I __C  uint8_t  RESERVED1[2];
...
typedef struct _ADI_AGPT0_TypeDef
{
    ...
    __I __C  uint8_t  RESERVED0[2];
    __I __C  int16_t    VAL0;                          /*!< 16-Bit Timer Value Register. */
    __I __C  uint8_t  RESERVED1[2];
    __IO     uint16_t   CON0;                          /*!< Control Register. */
    __I __C  uint8_t  RESERVED2[2];
    __O      uint16_t   CLRI0;                         /*!< Clear Interrupt Register. */
    __I __C  uint8_t  RESERVED3[2];
    __I __C  int16_t    CAP0;                          /*!< Capture Register. */
    __I __C  uint8_t  RESERVED4[2];
    __IO     int16_t    ALD0;                          /*!< 16-Bit Load Value, Asynchronous. */
    __I __C  uint8_t  RESERVED5[2];
    __I __C  int16_t    AVAL0;                         /*!< 16-Bit Timer Value, Asynchronous Register. */
    __I __C  uint8_t  RESERVED6[2];
    __I __C  uint16_t   STA0;                          /*!< Status Register. */
    __I __C  uint8_t  RESERVED7[2];
...
typedef struct _ADI_AGPT1_TypeDef
{
    ...
    __I __C  uint8_t  RESERVED0[2];
    __I __C  int16_t    VAL1;                          /*!< 16-bit Timer Value Register */
    __I __C  uint8_t  RESERVED1[2];
    __IO     uint16_t   CON1;                          /*!< Control Register */
    __I __C  uint8_t  RESERVED2[2];
    __O      uint16_t   CLRI1;                         /*!< Clear Interrupt Register */
    __I __C  uint8_t  RESERVED3[2];
    __I __C  int16_t    CAP1;                          /*!< Capture Register */
    __I __C  uint8_t  RESERVED4[2];
    __IO     int16_t    ALD1;                          /*!< 16-bit Load Value, Asynchronous Register */
    __I __C  uint8_t  RESERVED5[2];
    __I __C  int16_t    AVAL1;                         /*!< 16-bit Timer Value, Asynchronous Register */
    __I __C  uint8_t  RESERVED6[2];
    __I __C  uint16_t   STA1;                          /*!< Status Register */
    __I __C  uint8_t  RESERVED7[2];
...
typedef struct _ADI_AFE_TypeDef
{
    ...
    __I __C  uint8_t  RESERVED9[4];
    __IO     uint32_t   DACDCBUFCON;                   /*!< DAC DC Buffer Configuration */
    __I __C  uint8_t  RESERVED10[24];
    ...
    __I __C  uint8_t  RESERVED12[20];
    __IO     uint32_t   TEMPCON0;                      /*!< Temp Sensor Configuration */
    __I __C  uint8_t  RESERVED13[8];
    __IO     uint32_t   BUFSENCON;                     /*!< HP and LP Buffer Control */
    __I __C  uint8_t  RESERVED14[36];
    __IO     uint32_t   ADCCON;                        /*!< ADC Configuration */
    __I __C  uint8_t  RESERVED15[4];
    __I __C  uint32_t   DSWSTA;                        /*!< Switch Matrix Status (D) */
    __I __C  uint32_t   PSWSTA;                        /*!< Switch Matrix Status (P) */
    __I __C  uint32_t   NSWSTA;                        /*!< Switch Matrix Status (N) */
    __I __C  uint32_t   TSWSTA;                        /*!< Switch Matrix Status (T) */
    __I __C  uint32_t   STATSVAR;                      /*!< Variance Output */
    __IO     uint32_t   STATSCON;                      /*!< Statistics Control */
    __I __C  uint32_t   STATSMEAN;                     /*!< Statistics Mean Output */
    __I __C  uint8_t  RESERVED16[36];
    __IO     uint32_t   REPEATADCCNV;                  /*!< REPEAT ADC Conversions */
    __I __C  uint8_t  RESERVED17[60];
